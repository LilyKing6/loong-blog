...
app.get('/post', async (req, res) => {
  try {
    ...
    res.render('post', { post, comments: cd.comments || [], categoryName: catName, active: 'posts', formatDate, excerpt, renderMarkdown, extractTOC, req_query_page: req.query.page, error: null });
  } catch (e) {
